...
public class VerJugador extends JDialog {
    public VerJugador(Jugador jugador) {
        ...
        JLabel lblInfo = new JLabel("Informacion del Jugador");
        ...
        info.append("Edad: ").append(jugador.getEdad()).append("\n");
        info.append("Posici�n: ").append(jugador.getPosicionJugador()).append("\n");
        info.append("N�mero: ").append(jugador.getNumJugador()).append("\n");
        ...
        if (lesion != null) {
            ...
            info.append("Duracion total: ").append(lesion.getDuracion()).append(" dias\n");
            info.append("Dias restantes: ").append(diasRestantes).append("\n");
            info.append("Fecha recuperacion: ").append(calcularFechaRecuperacion(lesion)).append("\n");
        } else {
